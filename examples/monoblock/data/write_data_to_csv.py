...
copper_conductivity = [
    401,398,395,391,388,384,
    381,378,374,371,367,364,
    360,357,354,350,347,344,
    340,337,334,
]

with open("copper_conductivity.csv", 'w') as file:
...
copper_specific_heat = [
    388,390,394,398,401,406,
    410,415,419,424,430,435,
    441,447,453,459,466,472,
    479,487,494,
]

with open("copper_specific_heat.csv", 'w') as file:
...
copper_elastic_modulus = [
    117e9,116e9,114e9,112e9,110e9,108e9,
    105e9,102e9,98e9,
]

with open("copper_elastic_modulus.csv", 'w') as file:
...
copper_density = [
    8940,8926,8903,8879,8854,8829,
    8802,8774,8744,8713,8681,8647,
    8612,8575,8536,8495,8453,8409,
    8363,
]

with open("copper_density.csv", 'w') as file:
...
copper_cte = [
    16.7e-6,17.0e-6,17.2e-6,17.5e-6,17.7e-6,17.8e-6,
    18.0e-6,18.1e-6,18.2e-6,18.4e-6,18.5e-6,18.7e-6,
    18.8e-6,19.0e-6,19.1e-6,19.3e-6,19.6e-6,19.8e-6,
    20.1e-6,
]
...
cucrzr_conductivity = [
    318,324,333,339,343,345,
    346,347,347,346,346,
]

with open("cucrzr_conductivity.csv", 'w') as file:
...
cucrzr_specific_heat = [
    390,393,398,402,407,412,
    417,422,427,432,437,442,
    447,452,458,
]

with open("cucrzr_specific_heat.csv", 'w') as file:
...
cucrzr_elastic_modulus = [
    128e9,127e9,127e9,125e9,123e9,121e9,
    118e9,116e9,113e9,110e9,106e9,100e9,
    95e9,90e9,86e9,
]

with open("cucrzr_elastic_modulus.csv", 'w') as file:
...
cucrzr_density = [
    8900,8886,8863,8840,8816,8791,
    8797,8742,8716,8691,8665,
]

with open("cucrzr_density.csv", 'w') as file:
...
# Reference temperature 20 degC
cucrzr_cte = [
    16.7e-6,17.0e-6,17.3e-6,17.5e-6,17.7e-6,17.8e-6,
    18.0e-6,18.0e-6,18.1e-6,18.2e-6,18.4e-6,18.5e-6,
    18.6e-6,
]
...
tungsten_conductivity = [
    173,170,165,160,156,151,
    147,143,140,136,133,130,
    127,125,122,120,118,116,
    114,112,110,108,105,
]

with open("tungsten_conductivity.csv", 'w') as file:
...
with open("tungsten_specific_heat.csv", 'w') as file:
...
tungsten_elastic_modulus = [
    398e9,398e9,397e9,397e9,396e9,396e9,
    395e9,394e9,393e9,391e9,390e9,388e9,
    387e9,385e9,383e9,381e9,379e9,376e9,
    374e9,371e9,368e9,362e9,356e9,
]

with open("tungsten_elastic_modulus.csv", 'w') as file:
...
tungsten_density = [
    19300,19290,19280,19270,19250,19240,
    19230,19220,19200,19190,19180,19170,
    19150,19140,19130,19110,19100,19080,
    19070,19060,19040,19010,18990,
]

with open("tungsten_density.csv", 'w') as file:
...
# Reference temperature 20 degC
tungsten_cte = [
    4.50e-6,4.50e-6,4.53e-6,4.58e-6,4.63e-6,4.68e-6,
    4.72e-6,4.76e-6,4.81e-6,4.85e-6,4.89e-6,4.98e-6,
    5.08e-6,5.18e-6,5.30e-6,5.43e-6,5.57e-6,5.74e-6,
    5.93e-6,6.15e-6,6.40e-6,6.67e-6,
]
