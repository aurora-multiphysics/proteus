...
InputParameters ProteusTestApp::validParams() {
  InputParameters params = ProteusApp::validParams();
  return params;
}

ProteusTestApp::ProteusTestApp(InputParameters parameters)
    : MooseApp(parameters) {
  ProteusTestApp::registerAll(_factory, _action_factory, _syntax,
                              getParam<bool>("allow_test_objects"));
}

ProteusTestApp::~ProteusTestApp() {}

void ProteusTestApp::registerAll(Factory &f, ActionFactory &af, Syntax &s,
                                 bool use_test_objs) {
...
void ProteusTestApp::registerApps() {
...
extern "C" void ProteusTestApp__registerAll(Factory &f, ActionFactory &af,
                                            Syntax &s) {
  ProteusTestApp::registerAll(f, af, s);
}
extern "C" void ProteusTestApp__registerApps() {
