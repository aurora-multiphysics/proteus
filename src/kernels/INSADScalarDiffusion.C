...
InputParameters INSADScalarDiffusion::validParams() {
  InputParameters params = ADKernelGrad::validParams();
  params.addClassDescription(
      "This class computes the residual and Jacobian contributions for "
      "turbulent diffusion of a scalar.");
  params.addParam<MaterialPropertyName>("mu_lam_name", "mu_lam",
                                        "The name of the laminar viscosity");
...
ADRealVectorValue INSADScalarDiffusion::precomputeQpResidual() {
