...
InputParameters
INSADEpsilonProduction::validParams()
{
...
INSADEpsilonProduction::INSADEpsilonProduction(const InputParameters & parameters)
...
ADReal
INSADEpsilonProduction::precomputeQpResidual()
{
  if (_k[_qp] <= 0) {
    return 0;
  }
