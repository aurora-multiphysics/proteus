...
InputParameters TimeAverageAux::validParams() {
  InputParameters params = AuxKernel::validParams();

  params.addClassDescription(
      "AuxKernel that performs time averaging of variables.");
  params.addRequiredCoupledVar(
      "scalars", "Scalar variables to be averaged. If multiple scalars are "
